...
var o16268 = temp__5455__auto__;
var temp__5455__auto____$1 = (o16268["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o16269 = temp__5455__auto____$1;
return (o16269["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15380__auto__ = f;
return (o__15380__auto__["toString"]).call(o__15380__auto__);
} else {
return "";
}
}catch (e16270){var _ = e16270;
return "";
}});
...
try{var o__15380__auto___16272 = t;
(o__15380__auto___16272["cljs$lang$ctorPrWriter"]).call(o__15380__auto___16272,t,writer);
}catch (e16271){var __16273 = e16271;
}
...
var char_code = (function (){var o__15380__auto__ = (new String(char$));
return (o__15380__auto__["charCodeAt"]).call(o__15380__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15380__auto__ = String;
return (o__15380__auto__["fromCharCode"]).call(o__15380__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__16274 = num_code;
switch (G__16274) {
case (1):
return (185);
...
var o__15380__auto__ = String;
return (o__15380__auto__["fromCharCode"]).call(o__15380__auto__,superscript_code);
});
/**
...
}catch (e16276){var _e__15387__auto__ = e16276;
return false;
}})())){
...
var vec__16277 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__16277,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o16280 = temp__5455__auto__;
var temp__5455__auto____$1 = (o16280["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o16281 = temp__5455__auto____$1;
return (o16281["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16284){
var vec__16285 = p__16284;
var ns_detector = cljs.core.nth.call(null,vec__16285,(0),null);
...
var G__16291 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__16292 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__16291;
remaining_tokens = G__16292;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16282){
...
var vec__16296 = cljs.core.split_with.call(null,(function (p1__16295_SHARP_){
return cljs.core.not_EQ_.call(null,p1__16295_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__16296,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__16296,(1),null);
...
var vec__16299 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__16299,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__16299,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__16302 = cljs.core.rest.call(null,remaining_tokens);
var G__16303 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__16302;
name_tokens = G__16303;
continue;
} else {
...
var vec__16306 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__16306,(0),null);
var arity = cljs.core.nth.call(null,vec__16306,(1),null);
var vec__16309 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__16309,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__16309,(1),null);
var vec__16312 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__16312,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__16312,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__16312,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__16312,(3),null);
...
var vec__16318 = result;
var munged_ns = cljs.core.nth.call(null,vec__16318,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__16318,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__16318,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__16318,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__16318,(4),null);
var arity = cljs.core.nth.call(null,vec__16318,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__16322 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__16322,(0),null);
var args = cljs.core.nth.call(null,vec__16322,(1),null);
var vec__16325 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__16325,(0),null);
var name = cljs.core.nth.call(null,vec__16325,(1),null);
...
var G__16328 = (arity + (1));
var G__16329 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16330){
var vec__16331 = p__16330;
var arity = cljs.core.nth.call(null,vec__16331,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__16331,(1),null);
...
return cljs.core.get.call(null,arities,p1__16334_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__16335_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___16342 = arguments.length;
var i__4532__auto___16343 = (0);
while(true){
if((i__4532__auto___16343 < len__4531__auto___16342)){
args__4534__auto__.push((arguments[i__4532__auto___16343]));

var G__16344 = (i__4532__auto___16343 + (1));
i__4532__auto___16343 = G__16344;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16338){
var vec__16339 = p__16338;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__16339,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16336){
var G__16337 = cljs.core.first.call(null,seq16336);
var seq16336__$1 = cljs.core.next.call(null,seq16336);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16337,seq16336__$1);
});
...
var map__16347__$1 = ((((!((map__16347 == null)))?(((((map__16347.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16347.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16347):map__16347);
var include_ns_QMARK_ = cljs.core.get.call(null,map__16347__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__16347__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__16347__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__16347__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16348 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__16348,(0),null);
var fn_name = cljs.core.nth.call(null,vec__16348,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__16348,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__16348,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__16348,(4),null);
var arity = cljs.core.nth.call(null,vec__16348,(5),null);
...
var o__15380__auto__ = f;
return (o__15380__auto__["getBasis"]).call(o__15380__auto__);
});
/**
...
}catch (e16352){var _e__15387__auto__ = e16352;
...
var G__16353 = (obj[cljs.core.first.call(null,path)]);
var G__16354 = cljs.core.rest.call(null,path);
obj = G__16353;
path = G__16354;
continue;
} else {
...
return (function (accum,p__16355){
var vec__16356 = p__16355;
var bit = cljs.core.nth.call(null,vec__16356,(0),null);
var protocol = cljs.core.nth.call(null,vec__16356,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16359){
var vec__16360 = p__16359;
var ns = cljs.core.nth.call(null,vec__16360,(0),null);
var name = cljs.core.nth.call(null,vec__16360,(1),null);
var selector = cljs.core.nth.call(null,vec__16360,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__16365,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__16365,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__16365,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__16363_SHARP_){
return (obj[cljs.core.first.call(null,p1__16363_SHARP_)]);
});})(name,sorted_matches,vec__16365,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
