...
var G__16370 = devtools.prefs.pref.call(null,v);
v = G__16370;
continue;
} else {
return v;
...
}catch (e16373){var _e__15387__auto__ = e16373;
return false;
}})();
...
}catch (e16377){var _e__15387__auto__ = e16377;
return false;
}})();
...
}catch (e16379){var _e__15387__auto__ = e16379;
return false;
}}
}
});
...
var vec__16381 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16381,(0),null);
var name = cljs.core.nth.call(null,vec__16381,(1),null);
...
return cljs.core.some.call(null,(function (p1__16384_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16384_SHARP_);
}),template);
});
