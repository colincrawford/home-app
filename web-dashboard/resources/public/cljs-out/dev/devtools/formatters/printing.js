...
var len__4531__auto___16399 = arguments.length;
var i__4532__auto___16400 = (0);
while(true){
if((i__4532__auto___16400 < len__4531__auto___16399)){
args__4534__auto__.push((arguments[i__4532__auto___16400]));

var G__16401 = (i__4532__auto___16400 + (1));
i__4532__auto___16400 = G__16401;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16396){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16397,G__16398,seq16396__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16402_SHARP_){
return !((cljs.core.meta.call(null,p1__16402_SHARP_) == null));
})))){
...
var map__16403 = opts;
var map__16403__$1 = ((((!((map__16403 == null)))?(((((map__16403.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16403.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16403):map__16403);
var markup_db = cljs.core.get.call(null,map__16403__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16407){var _e__15387__auto__ = e16407;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e16409){var _e__15387__auto__ = e16409;
return false;
}}
})())){
...
var _STAR_current_state_STAR_16411 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__16412 = opts;
...
var markup_db = cljs.core.get.call(null,map__16412__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_16411;
}});
...
;
var temp__5455__auto___16416 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___16416)){
var managed_print_level_16417 = temp__5455__auto___16416;
var _STAR_print_level_STAR_16415_16418 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_16417;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_16415_16418,managed_print_level_16417,temp__5455__auto___16416,writer,opts,job_fn){
return (function (p1__16414_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16414_SHARP_,null);
});})(_STAR_print_level_STAR_16415_16418,managed_print_level_16417,temp__5455__auto___16416,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_16415_16418;
}} else {
job_fn.call(null);
}
