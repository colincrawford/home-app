...
var G__15187 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__15187,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__15187;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq15189){
var G__15190 = cljs.core.first.call(null,seq15189);
var seq15189__$1 = cljs.core.next.call(null,seq15189);
var G__15191 = cljs.core.first.call(null,seq15189__$1);
var seq15189__$2 = cljs.core.next.call(null,seq15189__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15190,G__15191,seq15189__$2);
});
...
var file = cljs.core.get.call(null,map__15196__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15196__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15196__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__15196,map__15196__$1,file,line,column){
return (function (p1__15195_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__15195_SHARP_));
});})(map__15196,map__15196__$1,file,line,column))
...
var temp__5457__auto___15198 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15198)){
var message_15199 = temp__5457__auto___15198;
cljs.core.println.call(null,message_15199);
} else {
}
...
var temp__5457__auto___15200 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15200)){
var message_15201 = temp__5457__auto___15200;
cljs.core.println.call(null,message_15201);
} else {
}
...
var output_dir__$1 = (function (){var G__15202 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15202),"/"].join('');
} else {
return G__15202;
}
})();
...
var G__15204 = exception.stack;
var G__15204__$1 = (((G__15204 == null))?null:clojure.string.split_lines.call(null,G__15204));
var G__15204__$2 = (((G__15204__$1 == null))?null:cljs.core.get.call(null,G__15204__$1,depth));
if((G__15204__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15204__$2);
}
} else {
...
var vec__15205 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__15205,(0),null);
var column = cljs.core.nth.call(null,vec__15205,(1),null);
var vec__15208 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__15208,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__15208,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__15208,(2),null);
...
var m__$1 = (function (){var G__15211 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__15215 = (function (){var G__15214 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__15214);
} else {
return G__15214;
}
})();
...
return cljs.core.vary_meta.call(null,G__15216,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__15220 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__15220,(0),null);
var types = vec__15220;
...
return cljs.core.map.call(null,(function (p__15223){
var vec__15224 = p__15223;
var ns = cljs.core.nth.call(null,vec__15224,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__15224,(1),null);
return ((function (vec__15224,ns,vars__$1){
return (function (){
...
var G__15227 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__15227__$1 = (((G__15227 instanceof cljs.core.Keyword))?G__15227.fqn:null);
switch (G__15227__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1){
return (function (){
var seq__15228 = cljs.core.seq.call(null,vars__$1);
var chunk__15229 = null;
var count__15230 = (0);
var i__15231 = (0);
while(true){
if((i__15231 < count__15230)){
var v = cljs.core._nth.call(null,chunk__15229,i__15231);
var temp__5457__auto___15233 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___15233)){
var t_15234 = temp__5457__auto___15233;
each_fixture_fn.call(null,((function (seq__15228,chunk__15229,count__15230,i__15231,t_15234,temp__5457__auto___15233,v,each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15234)));
});})(seq__15228,chunk__15229,count__15230,i__15231,t_15234,temp__5457__auto___15233,v,each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1))
);
} else {
}


var G__15235 = seq__15228;
var G__15236 = chunk__15229;
var G__15237 = count__15230;
var G__15238 = (i__15231 + (1));
seq__15228 = G__15235;
chunk__15229 = G__15236;
count__15230 = G__15237;
i__15231 = G__15238;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__15228);
if(temp__5457__auto__){
var seq__15228__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15228__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__15228__$1);
var G__15239 = cljs.core.chunk_rest.call(null,seq__15228__$1);
var G__15240 = c__4351__auto__;
var G__15241 = cljs.core.count.call(null,c__4351__auto__);
var G__15242 = (0);
seq__15228 = G__15239;
chunk__15229 = G__15240;
count__15230 = G__15241;
i__15231 = G__15242;
continue;
} else {
var v = cljs.core.first.call(null,seq__15228__$1);
var temp__5457__auto___15243__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___15243__$1)){
var t_15244 = temp__5457__auto___15243__$1;
each_fixture_fn.call(null,((function (seq__15228,chunk__15229,count__15230,i__15231,t_15244,temp__5457__auto___15243__$1,v,seq__15228__$1,temp__5457__auto__,each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_15244)));
});})(seq__15228,chunk__15229,count__15230,i__15231,t_15244,temp__5457__auto___15243__$1,v,seq__15228__$1,temp__5457__auto__,each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1))
);
} else {
}


var G__15245 = cljs.core.next.call(null,seq__15228__$1);
var G__15246 = null;
var G__15247 = (0);
var G__15248 = (0);
seq__15228 = G__15245;
chunk__15229 = G__15246;
count__15230 = G__15247;
i__15231 = G__15248;
continue;
}
} else {
...
});})(each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1))
);
});})(each_fixture_fn,G__15227,G__15227__$1,env,once_fixtures,each_fixtures,vec__15224,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15227__$1)].join('')));

}
})());
});
;})(vec__15224,ns,vars__$1))
