...
return cljs.core.map.call(null,(function (p1__15257_SHARP_){
return html_coll.item(p1__15257_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__15258_SHARP_);
...
var ctx_15259 = cvs.getContext("2d");
ctx_15259.fillStyle = color;

ctx_15259.fillRect((0),(0),size,size);
